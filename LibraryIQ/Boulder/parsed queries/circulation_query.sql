-- Circulation Query for LibraryIQ with Agency-based Subqueries
-- Retrieves circulation transaction data for LibraryIQ reporting
-- Split into two subqueries based on agency filtering

-- Subquery 1: Patrons with agency = 3 having transactions on items from any agency
SELECT

-- Large Items Query for LibraryIQ
-- This query retrieves comprehensive item data for LibraryIQ reporting
-- Used for full file generation on Fridays
